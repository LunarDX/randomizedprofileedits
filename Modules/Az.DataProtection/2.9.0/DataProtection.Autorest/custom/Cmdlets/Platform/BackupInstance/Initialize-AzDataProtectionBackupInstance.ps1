function Initialize-AzDataProtectionBackupInstance {
    ...
    process {
        ...
        $backupInstance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.BackupInstance]::new()
        ...
        if ($hasUseSystemAssignedIdentity -or $hasUserAssignedIdentityArmId) {
            ...
            $backupInstance.IdentityDetail = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.IdentityDetails]::new()
        ...
        {            
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $backupInstance.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.SecretStoreBasedAuthCredentials]::new()
                $backupInstance.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $backupInstance.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.SecretStoreResource]::new()
        ...
        $backupInstanceResource = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.BackupInstanceResource]::new()
        ...
        {
            $operationalParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20250901.AzureOperationalStoreParameters]::new()
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBVJTU1uS20mROn
# GgwcgkJJ0NJwFr7li48b3NPJnDg+dKCCDXYwggX0MIID3KADAgECAhMzAAAEhV6Z
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILARnEF/9PGD9pvsa8dXsUFc
# o2xdS50YTzzF2up/PdRkMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAm43SUo+8WnKhzz7FJBFmuKFLfD1I+NrSxUNH5qysDjFlWlgVt6/oHECC
# scgmRg0UkWWac/LRnYYVjb+8pPxj/ZyxFyAx998MTo2eoAZsiftOg/qfdrXB+qq2
# pXfceZcQAbCy+rDP8t19RSDslkMGh0EThrdMYR3Bw8Qt8qpB7DLN8wR4gniGVwoB
# 7cHH8nyWNnoIR51re1wlOdVjN0lMO3kctDpsiPEp6zF491wuXa1Xs7YvxN11lpTN
# 1Bikzsr8A2U0kIaIatao37IibIpjm4hj48cFeRmrTP1Rx2k2YIP6e5sAM1eMmP5c
# 47BU7YtaTowID19mm74zquQPQl6fR6GCF5cwgheTBgorBgEEAYI3AwMBMYIXgzCC
# F38GCSqGSIb3DQEHAqCCF3AwghdsAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCC5RMWPs0X8lirz3Yj3R9KaRmgHVq0V3GPYDRUB+bE89QIGaWkUONrI
# GBMyMDI2MDEyNzA3Mzk1OS44MjRaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# MC8GCSqGSIb3DQEJBDEiBCB6/WkS5iWOTUT5zXNE9XvaALrX+j3qaXPFShOP15Hv
# TzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EII//jm8JHa2W1O9778t9+Ft2
...
# tDFXJOlBZzXxkB44AvEwDQYJKoZIhvcNAQELBQAEggIAqseutmYC6oDkJVPzaY7/
# VW1ZAeG/NKQpvZswKAyzT6HDM899PPd7rIGfvS26h0s7KQ950aejIH0KBKS1bneq
# xooYSyV5N72nrEU/MsqEsUIqRTMbNjpZ3uxPQbIjeBsP1SjFB0OsCOy88Fp8jkLm
# Ton8jC78qUjZTioRb5qEL5EZgfbaT/ImpDFza8xe0Z9B9LfKnpk5LvioFcu/1sFy
# hmkPlIlGH0LgIT/A2q4KzaZaoCTjgEKh5qXNFWhm6TZsgmDThWgFwPgAbFuc4zl6
# /xT4xWaoBvEsozJgTHnItUWlOeFXL1/ftLmt/dmPULSypT7maxMdAR4wQ31t3ZLa
# nG59xvXXTXsKhzkRlMUOwoNe9szZFNbNL1KVChSn7uOd3g0EKmD35u/HkuQVYb3n
# WhhLRdrBvhJJWcW1XLn0bt/MckdTSns2CQNJZJrJkds3kUtOS4GPv205POQhxsc7
# ijZkGhcVu2gBkPPFnFIup9kTdh8xTQvRVa6hX9RuYYIMqtE02bpO/If6V/j2M5WZ
# C0dbijo7IjkjgacP+a7oCbprjdaZW+vX+kS2tbaPpGj+o9HMiYeLHc0uIdXM1TNK
# 0aOMIc5xS/3icxF7Qr3bm4E1xGRMFnNIxA66/iRkkUExvdhodHtNcekyBw99mcEd
# GGM9UKX707DGzAzBM9nQL/E=
